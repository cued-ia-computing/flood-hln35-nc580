...
dates = [datetime.datetime(2021, 3, 2, 12, 45), datetime.datetime(2021, 3, 2, 12, 30),
         datetime.datetime(2021, 3, 2, 12, 15),
         datetime.datetime(2021, 3, 2, 12, 0), datetime.datetime(2021, 3, 2, 11, 0),
         datetime.datetime(2021, 3, 2, 10, 45), datetime.datetime(2021, 3, 2, 10, 30),
         datetime.datetime(2021, 3, 2, 10, 15),
         datetime.datetime(2021, 3, 2, 10, 0)]

# Dates1 is a list of 10 dates
dates1 = [datetime.datetime(2021, 3, 2, 13, 0), datetime.datetime(2021, 3, 2, 12, 45),
          datetime.datetime(2021, 3, 2, 12, 30),
          datetime.datetime(2021, 3, 2, 12, 15), datetime.datetime(2021, 3, 2, 12, 0),
          datetime.datetime(2021, 3, 2, 11, 0),
          datetime.datetime(2021, 3, 2, 10, 45),
          datetime.datetime(2021, 3, 2, 10, 30), datetime.datetime(2021, 3, 2, 10, 15),
          datetime.datetime(2021, 3, 2, 10, 0)]
